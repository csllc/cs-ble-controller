...
var controllerGnssCharacteristicUuid = '0001';

var controllerFaultLogCharacteristicUuid = '0003';
var controllerMetersCharacteristicUuid = '0004';
var controllerMotorCharacteristicUuid = '0005';
var controllerStateCharacteristicUuid = '0006';


function ControllerList( id ) {
  this.list = [];
}

ControllerList.prototype.add = function( id ) {
...
ControllerList.prototype.isKnown = function( id ) {
...
var gnssCharacteristic = null;

var faultLogCharacteristic = null;

var metersCharacteristic = null;
        ...
        service.discoverCharacteristics([], function(err, characteristics) {
          ...
          characteristics.forEach(function(characteristic) {
            ...
            switch( characteristic.uuid ) {
              case controllerGnssCharacteristicUuid:
                gnssCharacteristic = characteristic;
                break;

              case controllerFaultLogCharacteristicUuid:
                faultLogCharacteristic = characteristic;
                break;

              case controllerMetersCharacteristicUuid:
                metersCharacteristic = characteristic;
                break;

              case controllerMotorCharacteristicUuid:
                motorCharacteristic = characteristic;
                break;

              case controllerStateCharacteristicUuid:
...
//var controllerStateCharacteristicUuid = '0006';
          ...
          if (1) {
            ...
            faultLogCharacteristic.read( function(error, data) {

              console.log( 'Read Fault Log: ', data );
            });

            var fault = new Buffer(16);
            fault.fill(0xEE);

            faultLogCharacteristic.write( fault, false, function(err) {
